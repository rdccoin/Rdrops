...
// Copyright (c) 2014 The Raindrops developers
...
// for both Raindropsd and Raindrops(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Raindrops releases, the client name should be selected from

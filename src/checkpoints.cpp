...
namespace Checkpoints
{
    ...
    static MapCheckpoints mapCheckpoints =
        ...
        ( 9000, uint256("0x0000000000af5ccc03d0d1c8c36427a48a377349474b64c8582423aac31a26d3"))
    ...
    // Raindrops: synchronized checkpoint (centrally broadcasted)
    ...
    // Raindrops: get last synchronized checkpoint
    ...
    // Raindrops: only descendant of current sync-checkpoint is allowed
    ...
    // Raindrops: reset synchronized checkpoint to last hardened checkpoint
...
// Raindrops: sync-checkpoint master key
...
// Raindrops: verify signature of sync-checkpoint message
...
// Raindrops: process synchronized checkpoint

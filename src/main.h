...
static const int64 MAX_MINT_PROOF_OF_WORK = 750 * COIN;
...
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // stake age of full weight Raindrops days
...
static const uint256 hashGenesisBlockOfficial("0x00000bef6ab0b9e46bd81de516e59b5016013eb8d2076416ba7175106d5f6ee1");
...
public:
    ...
    {
        // Raindrops: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // Raindrops: get transaction coin age
...
public:
    ...
    // Raindrops: block signature - signed by coin base txout[0]'s owner
    ...
    // Raindrops: two types of block: proof-of-work or proof-of-stake
    ...
    // Raindrops: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // Raindrops: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // Raindrops: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // Raindrops: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // Raindrops: block index flags
    enum  
    {

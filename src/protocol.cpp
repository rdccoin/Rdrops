...
// Raindrops message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xfd, 0xfe, 0xc4, 0xfc };
static unsigned char pchMessageStartRaindrops[4] = { 0xf6, 0xc5, 0xf3, 0xeb };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartRaindrops : pchMessageStartBitcoin, sizeof(pchMessageStartRaindrops));
}

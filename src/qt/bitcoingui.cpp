 ...
 * The Raindrops Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Raindrops Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/Raindrops_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Raindrops address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/Raindrops_tooltip"), tr("&About Raindrops"), this);
    aboutAction->setToolTip(tr("Show information about Raindrops"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qt"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));    
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Raindrops"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/Raindrops_tooltip"), tr("Show/Hide &Raindrops"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Raindrops window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/Raindrops_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Raindrops_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/Raindrops_tooltip"));
            }
        }
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Raindrops client"));
    trayIcon->setIcon(QIcon(":/icons/Raindrops_tooltip"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Raindrops network", "", count));
}

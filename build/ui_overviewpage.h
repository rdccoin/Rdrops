...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        label_7->setPixmap(QPixmap(QString::fromUtf8(":/icons/Raindrops_testnet")));

        verticalLayout_2->addWidget(label_7, 0, Qt::AlignHCenter|Qt::AlignBottom);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        label_5->setText(QApplication::translate("OverviewPage", "Raindrops ", 0, QApplication::UnicodeUTF8));

...
public:
    ...
    QLabel *label_4;
    QLabel *label_Raindrops_copyright;
    QLabel *label_2;
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_Raindrops_copyright = new QLabel(AboutDialog);
        label_Raindrops_copyright->setObjectName(QString::fromUtf8("label_Raindrops_copyright"));
        label_Raindrops_copyright->setWordWrap(true);
        label_Raindrops_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_Raindrops_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Raindrops", 0, QApplication::UnicodeUTF8));
        label_3->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">Raindrops</span></p></body></html>", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 Raindrops Developers", 0, QApplication::UnicodeUTF8));
        label_Raindrops_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2011-2014 Raindrops Developers", 0, QApplication::UnicodeUTF8));
